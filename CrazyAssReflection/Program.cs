...
Console.WriteLine(await rrrrr);
Console.ReadLine();
async Task<int> thrower()
{
    await Task.Delay(0);
    throw new Exception("aklsehfwert4rw");
}

async Task<int> Sup(Task<int> t)
{
    try
    {
        await t;
...
async ValueTask<int> Sup2(ValueTask<int> t)
{
    try
    {
        await t;
